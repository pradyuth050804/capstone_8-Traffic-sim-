    ...
    extend: {
      colors: {
        ...
        map: {
          ...
          "road-highlight": "hsl(var(--map-road-highlight))",
      ...
      boxShadow: {
        ...
        'elevated': '0 10px 40px -10px rgba(0, 0, 0, 0.1), 0 4px 15px -3px rgba(0, 0, 0, 0.05)',
        'card': '0 1px 3px rgba(0, 0, 0, 0.05), 0 4px 6px rgba(0, 0, 0, 0.03)',
      ...
      animation: {
        ...
        "vehicle-flow": "vehicle-flow 4s linear infinite",
